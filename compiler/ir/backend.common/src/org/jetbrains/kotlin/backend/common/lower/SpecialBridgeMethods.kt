...
class SpecialBridgeMethods(val context: CommonBackendContext) {
    ...
    private val SPECIAL_METHODS_WITH_DEFAULTS_MAP = mapOf(
        ...
        makeDescription(KotlinBuiltIns.FQ_NAMES.map, "getOrDefault", 2) to
                SpecialMethodWithDefaultInfo(::getSecondArg, 1, isGeneric = true),
        makeDescription(KotlinBuiltIns.FQ_NAMES.map, "get", 1) to
                SpecialMethodWithDefaultInfo(::constNull, 1, isGeneric = true),
    ...
    private val SPECIAL_PROPERTIES_SET = mapOf(
        ...
        makeDescription(KotlinBuiltIns.FQ_NAMES.map, "keys") to BuiltInWithDifferentJvmName(isGeneric = true),
        makeDescription(KotlinBuiltIns.FQ_NAMES.map, "values") to BuiltInWithDifferentJvmName(isGeneric = true),
        makeDescription(KotlinBuiltIns.FQ_NAMES.map, "entries") to BuiltInWithDifferentJvmName(isGeneric = true)
    )
    ...
    private val SPECIAL_METHODS_SETS = mapOf(
        ...
        makeDescription(KotlinBuiltIns.FQ_NAMES.mutableList, "removeAt", 1) to BuiltInWithDifferentJvmName(isGeneric = true)
    )
