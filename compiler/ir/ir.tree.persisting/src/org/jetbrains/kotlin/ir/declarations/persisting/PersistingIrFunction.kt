...
import org.jetbrains.kotlin.ir.declarations.persisting.carriers.FunctionCarrier
...
abstract class PersistingIrFunctionCommon(
    startOffset: Int,
    endOffset: Int,
    ...
    PersistingIrFunctionBase<FunctionCarrier>(startOffset, endOffset, origin, name, visibility, isInline, isExternal, isExpect, returnType),
    IrSimpleFunction,
    FunctionCarrier {
...
) : PersistingIrFunctionCommon(startOffset, endOffset, origin, name, visibility, modality, returnType, isInline,
...
class PersistingIrFakeOverrideFunction(
    startOffset: Int,
    endOffset: Int,
    origin: IrDeclarationOrigin,
    name: Name,
